...
export const Home = () => ( < div className = "container-fluid text-center mt-5 bg-dark" >
    <
    ...
    div className = "card-body" >
    <
    p className = "card-title" > C - 3 PO < /p> </div > <
    /div>
    ...
    div className = "card border-dark my-3 mx-2 text-bg-dark" >
    <
    img src = "https://starwars-visualguide.com/assets/img/characters/4.jpg"
    className = "card-img-top"
    alt = "..." / >
    <
    div className = "card-body" >
